...
public class ATrustProcessTest {
	...
	private static final BpmProcess integrationProcess = BpmProcess.path("ATrustIntegration/DemoStart");
	private static final BpmProcess aTrustSignerProcess = BpmProcess.path("ATrustSigner/StartSignature");
	...
	public void getListTemplateProcess(BpmClient bpmClient) {
		...
		atrust.connector.demo.Data demoData = (atrust.connector.demo.Data) data;
